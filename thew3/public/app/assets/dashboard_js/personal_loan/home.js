...
//    });
    ...
    $('.linecreditcancelbtn').click(function () {
        var home_url = global.base_url + 'personalloan/logout';
...
//    });
    ...
    $('.btnCloselogin.btnCloselogin1').click(function () {
        $('.mainsteploginbx').hide();
    });
...
function messageBox() {
    ...
    $.ajax({
        url: global.base_url + "home/messageBoxMail",
        type: "post",
        ...
        success: function (response) {
            ...
            $("#mail_error").remove();
            if (response.status) {
                var msg1 = "<div id='mail_success' style='color:green'>Your request has been submitted.We will get back to you soon.</div>";
                $(".getformbx").append(msg1);
            } else {
                var msg2 = "<div id='mail_error' style='color:red'>Unable to submit your request.Please try after some time.</div>";
                $(".getformbx").append(msg2);
            }
            $(".getformbx input,textarea").html("").val("");
        }
    });
